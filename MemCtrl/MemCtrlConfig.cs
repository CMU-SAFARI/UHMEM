...
//        public int writeq_max_per_bank = 4;
        ...
        public int readq_max_per_bank = 8;
        public int writeq_max_per_bank = 4;
        ...
        public string wbmode_algo2 = "DecoupledWBFullDrain2";
        public Type typeof_wbmode_algo;
        public Type typeof_wbmode_algo2;
        ...
        public override void finalize()
        {
            ...
            string type_name2 = typeof(Sim).Namespace + "." + Config.mctrl.wbmode_algo2;
            try {
                typeof_wbmode_algo = Type.GetType(type_name);
                typeof_wbmode_algo2 = Type.GetType(type_name2);
            }
            catch {
