...
namespace MemMap
{
    public class DecoupledWBFullRDEmptyIdleRDBusyDrain : MemWBMode
    {
        ...
        public DecoupledWBFullRDEmptyIdleRDBusyDrain(MemCtrl[] mctrls)
            : base(mctrls)
        {
        ...
        public override void tick(uint cid)
        {
            ...
            for (uint i = 0; i < cmax; i++) {
                ...
                if (!is_writeq_empty(i) && !is_readq_busy(i))
                    continue;
