...
namespace MemMap
{
    ...
    public class Config : ConfigGroup
    {
        ...
        public static MemConfig2 mem2 = new MemConfig2();
        public static MemCtrlConfig mctrl = new MemCtrlConfig();
        public static MemSchedConfig sched = new MemSchedConfig();

        //simulation
        public enum SIM_TYPE {CYCLE, INST, COMPLETION, PARALLEL, GROUPED};
        public static int group_boundary = 4;  // threads in [group_boundary, N) are the parallel threads
...
//yang:
        public static ulong warmup_inst_max = 900000000;
        ...
        //task-based
        public static bool task_based = false;

        //reuse analysis
        public static bool collect_reuse = false;
