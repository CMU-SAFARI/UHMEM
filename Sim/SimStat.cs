...
namespace MemMap
{
    ...
    public class Stat : StatGroup
    {
        ...
        public static MemCtrlStat[] mctrls = new MemCtrlStat[Config.mem.channel_max * Config.mem.mctrl_num];
        public static MemCtrlStat[] mctrls2 = new MemCtrlStat[Config.mem.channel_max * Config.mem.mctrl_num];
        public static BusStat[] busses = new BusStat[Config.mem.channel_max];
        public static BusStat[] busses2 = new BusStat[Config.mem.channel_max];
        public static BankStat[,,] banks = new BankStat[Config.mem.channel_max, Config.mem.rank_max, 8];
        public static BankStat[,,] banks2 = new BankStat[Config.mem.channel_max, Config.mem.rank_max, 8];
        public static MemSchedStat[] scheds = new MemSchedStat[Config.mem.channel_max];
        public static MemSchedStat[] scheds2 = new MemSchedStat[Config.mem.channel_max];
        ...
        public void Report(TextWriter tw)
        {
            ...
            tw.WriteLine("\"mctrl2\":");
            tw.WriteLine("[");
            for (int i = 0; i < mctrls2.Length; i++)
            {
                mctrls2[i].DumpJSON(tw);
                if (i != mctrls2.Length - 1)
                    tw.WriteLine(",");
            }
            tw.WriteLine("],");
            ...
            for (int i = 0; i < busses2.Length; i++) {
                busses2[i].DumpJSON(tw);
                if (i != busses2.Length - 1)
                    tw.WriteLine(",");
            }
            tw.WriteLine("],");
