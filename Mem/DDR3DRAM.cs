...
namespace MemMap
{
    public class DDR3DRAM
    {
        ...
        public enum DDR3Enum
        {
            //tRCD-tRP-tCL
            DDR3_2Gb_x8_1066_8_8_8,
            DDR3_2Gb_x8_1066_8_8_8_InfiniteBusBW,
            DDR3_2Gb_x8_1333_10_10_10,
            DDR3_2Gb_x8_1600_11_11_11,
            PCM_2Gb_x8_1066_36_8_8
        }
...
//yang:
            ...
            COL_MAX = 8 * 1024 / 64;   //each row has 1k columns, each bank has 8 subarrays, totally 8 chips so page size is 8KB; In terms of block, it is 1/8 K Blocks.
            DEVICE_WIDTH = 8;
        ...
        private void DDR3_2Gb_x8_1066_8_8_8_InfiniteBusBW() {
            BANK_MAX = 8;   //fixed for DDR3
            ROW_MAX = 32 * 1024;
            COL_MAX = 8 * 1024 / 64;
            DEVICE_WIDTH = 8;
            ...
            timing.tCL = 8;    //8_8_8
            timing.tCWL = 6;
            timing.tBL = 0;    //bursts happen instantly
