...
namespace MemMap
{
    ...
    public static class MemMap
    {
        ...
        //bits
        public static uint chan_bits;
        public static uint rank_bits;
        public static uint bank_bits;
        public static uint col_bits;
        public static uint col1_bits;
        public static uint col2_bits;
        public static uint transfer_bits;
